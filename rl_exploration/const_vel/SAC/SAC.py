...
class SAC(object):
    ...
    def __init__(
        ...
        save_directory=Path("src/DRL-exploration/const_vel/models/SAC"),
        model_name="SAC",
        load_directory=Path("src/DRL-exploration/const_vel/models/SAC"),
    ):
        super().__init__()
    ...
    def prepare_state(self, latest_scan, odom, collision, action):
        ...
        large_threshold = 1e+20  # Adjust based on your needs
        ...
        latest_scan[invalid_mask] = 7.0

        # print(latest_scan)
        main_states_dim = 3        # the odom2 action2
        max_bins = self.state_dim - main_states_dim   # 18
        ...
        # print(min_values)
        state = min_values + [odom.x , odom.y] + [action[0]]
        # print(state)
