...
def generate_launch_description():
    ...
    robots = [
        {'name': 'tb3_0', 'x_pose': 0.0, 'y_pose': 0.5, 'z_pose': 0.01,
                           'roll': 0.0, 'pitch': 0.0, 'yaw': 0.0},
        # {'name': 'tb3_1', 'x_pose': 0.0, 'y_pose': -0.5, 'z_pose': 0.01,
        #                    'roll': 0.0, 'pitch': 0.0, 'yaw': 0.0}
        ]
    ...
    declare_robot1_params_file_cmd = DeclareLaunchArgument(
        'tb3_0_params_file',
        default_value=os.path.join(get_package_share_directory('human_robot_pkg'), 'config', 'tb3_0_nav2_params.yaml'),
